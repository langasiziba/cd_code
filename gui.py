...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.samplec_input.setGeometry(QRect(140, 430, 155, 21))
        ...
        self.btn_start.setGeometry(QRect(100, 730, 81, 31))
        font5 = QFont()
        ...
        self.btn_abort = QPushButton(self.spectrasetup_group)
        self.btn_abort.setObjectName(u"btn_abort")
        self.btn_abort.setGeometry(QRect(190, 730, 81, 31))
        ...
        self.path_input.setGeometry(QRect(140, 470, 155, 21))
